...
import static dormz.xp.installer.util.InstallZipUtil.closeSilently;
import static dormz.xp.installer.util.InstallZipUtil.reportMissingFeatures;
import static dormz.xp.installer.util.InstallZipUtil.triggerError;
