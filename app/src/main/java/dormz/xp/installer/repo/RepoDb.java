package dormz.xp.installer.repo;
...
import dormz.xp.installer.repo.RepoDbDefinitions.InstalledModulesColumns;
import dormz.xp.installer.repo.RepoDbDefinitions.InstalledModulesUpdatesColumns;
import dormz.xp.installer.repo.RepoDbDefinitions.ModuleVersionsColumns;
import dormz.xp.installer.repo.RepoDbDefinitions.ModulesColumns;
import dormz.xp.installer.repo.RepoDbDefinitions.MoreInfoColumns;
import dormz.xp.installer.repo.RepoDbDefinitions.OverviewColumns;
import dormz.xp.installer.repo.RepoDbDefinitions.OverviewColumnsIndexes;
import dormz.xp.installer.repo.RepoDbDefinitions.RepositoriesColumns;
import dormz.xp.installer.util.ModuleUtil.InstalledModule;
import dormz.xp.installer.XposedApp;
import dormz.xp.installer.util.ModuleUtil;
import dormz.xp.installer.util.RepoLoader;
