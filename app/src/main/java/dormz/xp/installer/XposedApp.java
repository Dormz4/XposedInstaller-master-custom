...
import dormz.xp.installer.util.InstallZipUtil.XposedProp;
import dormz.xp.installer.util.AssetUtil;
import dormz.xp.installer.util.DownloadsUtil;
import dormz.xp.installer.util.InstallZipUtil;
import dormz.xp.installer.util.NotificationUtil;
...
public class XposedApp extends Application implements ActivityLifecycleCallbacks {
    ...
    private static final String BASE_DIR_LEGACY = "/data/data/dormz.xp.installer/";

    public static final String BASE_DIR = Build.VERSION.SDK_INT >= 24
            ? "/data/user_de/0/dormz.xp.installer/" : BASE_DIR_LEGACY;
    ...
    public static void installApk(Context context, DownloadsUtil.DownloadInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            uri = FileProvider.getUriForFile(context, "dormz.xp.installer.fileprovider", new File(info.localFilename));
